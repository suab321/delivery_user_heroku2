...
const verfiy=(email,token,Name)=>{
    const mailoption={
        ...
        html:'<h3> Hi '+Name+', </h3><p>Thank you and welcome to Stowaway. To activate your account, please click on the link below.</p><p><a href="https://rocky-harbor-81451.herokuapp.com/authentication/verification/'+token+'">'+token+'</a></p><p>If you are having trouble clicking the link, please copy and paste the URL above in your web browser.</p><p>Thanks,<br>Team Stowaway</p>'
    }
...
const resetpass=(email,token,Name)=>{
    const mailoption={
        ...
        html:'<h3>Hi '+Name+', </h3><p>You recently requested to reset your password for your Stowaway account. Click on the link below to reset your password.</p><p><a href="https://rocky-harbor-81451.herokuapp.com/authentication/reseting/'+token+'">'+token+'</a></p><p>Or, please copy and paste the above URL in your web browser.</p><br><p>Thanks,<br>Team Stowaway</p>'
    }
